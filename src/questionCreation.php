<?php
    ...
    if (isset($_POST['submit'])) {
      ...
      $title = $_POST['title'];
      $detail = $_POST['detail'];
      $searchArray = $postClass->insertPosts($title, $detail);
...
<html lang="en">
  ...
  <form action="questionCreation.php" method="post">
    ...
    <div class="d-flex">
      <button  type="submit" name="submit" class="justify-content-center btn custom-button">投稿する</button>
